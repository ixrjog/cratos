 ...
 */
@Component
public class GcpProjectSettingsBuilder extends BaseGoogleCloudSettingsBuilder {

    public GcpProjectSettingsBuilder(EdsConfigService edsConfigService, CredentialService credentialService) {
