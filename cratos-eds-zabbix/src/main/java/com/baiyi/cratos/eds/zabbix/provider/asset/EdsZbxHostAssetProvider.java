...
public class EdsZbxHostAssetProvider extends BaseEdsAssetProvider<EdsConfigs.Zabbix, ZbxHostResult.Host> {

    public EdsZbxHostAssetProvider(EdsAssetProviderContext context) {
        super(context);
    }
