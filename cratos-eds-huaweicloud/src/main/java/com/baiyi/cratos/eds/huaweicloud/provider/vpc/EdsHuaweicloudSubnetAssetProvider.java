...
public class EdsHuaweicloudSubnetAssetProvider extends BaseHasRegionsEdsAssetProvider<EdsHuaweicloudConfigModel.Huaweicloud, HuaweicloudSubnet.Subnet> {
    ...
    @Override
    protected List<HuaweicloudSubnet.Subnet> listEntities(String regionId,
                                                          EdsHuaweicloudConfigModel.Huaweicloud configModel) throws EdsQueryEntitiesException {
        List<Subnet> subnets = HuaweicloudVpcRepo.listSubnets(regionId, configModel);
    ...
    private List<HuaweicloudSubnet.Subnet> toEntities(String regionId,
                                                      EdsHuaweicloudConfigModel.Huaweicloud configModel,
                                                      List<Subnet> subnets) {
        return subnets.stream()
                .map(e -> HuaweicloudSubnet.toSubnet(regionId,
                        HuaweicloudProjectUtil.findProjectId(regionId, configModel), e))
                .toList();
    }

    @Override
    protected EdsAsset toEdsAsset(ExternalDataSourceInstance<EdsHuaweicloudConfigModel.Huaweicloud> instance,
                                  HuaweicloudSubnet.Subnet entity) {
    ...
    protected List<EdsAssetIndex> toEdsAssetIndexList(ExternalDataSourceInstance<EdsHuaweicloudConfigModel.Huaweicloud> instance,
                                                      EdsAsset edsAsset, HuaweicloudSubnet.Subnet entity) {
