...
public class AmazonRoute53DomainsService {
    ...
    public static AmazonRoute53Domains buildAmazonRoute53Domains(EdsConfigs.Aws aws) {
        return buildAmazonRoute53Domains(GLOBAL, aws);
    }

    public static AmazonRoute53Domains buildAmazonRoute53Domains(String regionId, EdsConfigs.Aws aws) {
