...
public class AwsEcsInstanceManagement {
    ...
    public void startInstance(String regionId, EdsConfigs.Aws aws, String instanceId) {
    ...
    public void stopInstance(String regionId, EdsConfigs.Aws aws, String instanceId) {
        StopInstancesRequest request = new StopInstancesRequest();
        request.setInstanceIds(Set.of(instanceId));
        StopInstancesResult result = buildAmazonEC2(regionId, aws).stopInstances(request);
    }

    public void rebootInstance(String regionId, EdsConfigs.Aws aws, String instanceId) {
