 ...
 * &#064;Version 1.0
 */
public abstract class BaseHasRegionsEdsAssetProvider<C extends HasRegionModel & IEdsConfigModel, A> extends BaseEdsInstanceAssetProvider<C, A> {
    ...
    protected Set<String> getRegionSet(C configModel) {
