 ...
 */
@Slf4j
public abstract class BaseHasRegionsEdsAssetProvider<Config extends HasRegions & HasEdsConfig, Asset> extends BaseEdsAssetProvider<Config, Asset> {

    public BaseHasRegionsEdsAssetProvider(EdsAssetProviderContext context) {
        super(context);
    }
