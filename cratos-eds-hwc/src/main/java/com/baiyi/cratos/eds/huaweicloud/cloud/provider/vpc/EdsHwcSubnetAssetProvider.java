...
public class EdsHwcSubnetAssetProvider extends BaseHasRegionsEdsAssetProvider<EdsConfigs.Hwc, HwcSubnet.Subnet> {

    public EdsHwcSubnetAssetProvider(EdsAssetProviderContext context) {
        super(context);
    }
