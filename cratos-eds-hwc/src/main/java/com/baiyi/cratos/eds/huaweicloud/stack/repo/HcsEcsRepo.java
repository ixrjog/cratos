...
public class HcsEcsRepo {
    ...
    public static List<ServerDetail> listServers(EdsConfigs.Hcs hcStack) throws ServiceResponseException {
    ...
    public static List<CloudServer> listCloudServers(EdsConfigs.Hcs hcStack) throws ServiceResponseException {
