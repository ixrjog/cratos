...
import com.baiyi.cratos.eds.huaweicloud.cloud.model.HwcEcs;
...
public class EdsHwcEcsAssetProvider extends BaseHasRegionsEdsAssetProvider<EdsConfigs.Hwc, HwcEcs.Ecs> {

    public EdsHwcEcsAssetProvider(EdsAssetProviderContext context) {
        super(context);
    }
    ...
    private List<HwcEcs.Ecs> toEntities(String regionId, EdsConfigs.Hwc configModel,
    ...
    protected EdsAsset toAsset(ExternalDataSourceInstance<EdsConfigs.Hwc> instance,
        ...
        return createAssetBuilder(instance, entity).assetIdOf(assetId)
                ...
                .createdTimeOf(TimeUtils.toDate(entity.getServerDetail()
                        .getCreated(), DateFormatEnum.ISO8601
                ))
