...
public class WorkOrderVO {
    ...
    public static class WorkOrder implements BaseBusiness.IBusinessAnnotate, I18nModel.HasI18n, BusinessDocVO.HasBusinessDocs, BusinessTagVO.HasBusinessTags, Serializable {
        @Serial
        private static final long serialVersionUID = 883502875092939363L;
        private Integer id;
        private String name;
