...
/**
 * &#064;Author  baiyi
 * &#064;Date  2025/5/19 11:17
 * &#064;Version 1.0
 */
@Slf4j
@Component
public class CreateAliyunRamUserNoticeSender extends BaseWorkOrderNoticeSender {

    public CreateAliyunRamUserNoticeSender(WorkOrderNoticeSenderContext context) {
        super(context);
    }
    ...
    private void sendMsgToUser(User sendToUser, Map<String, Object> dict) {
        sendMsgToUser(sendToUser, NotificationTemplateKeys.CREATE_ALIYUN_RAM_USER_NOTICE, dict);
    }
