...
/**
 * &#064;Author  baiyi
 * &#064;Date  2025/12/4 10:41
 * &#064;Version 1.0
 */
@Slf4j
@Component
public class CreateAwsIamUserNoticeSender extends BaseWorkOrderNoticeSender {

    public CreateAwsIamUserNoticeSender(WorkOrderTicketEntryService workOrderTicketEntryService,
    ...
    public void sendMsg(WorkOrder workOrder, WorkOrderTicket ticket, String accountId, String iamUsername,
                        String password, String secretKey, String loginLink, User applicantUser) {
        Map<String, Object> dict = SimpleMapBuilder.newBuilder()
                ...
                .put("awsIAMUsername", iamUsername)
    ...
    private void sendMsgToUser(User sendToUser, Map<String, Object> dict) {
        sendMsgToUser(sendToUser, NotificationTemplateKeys.CREATE_AWS_IAM_USER_NOTICE, dict);
    }
