...
/**
 * &#064;Author  baiyi
 * &#064;Date  2025/11/13 14:17
 * &#064;Version 1.0
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public class RevokeUserEdsAzureUserPermissionTicketEntryBuilder {

    private WorkOrderTicketParam.AddRevokeUserEdsAccountPermissionTicketEntry param;

    public static RevokeUserEdsAzureUserPermissionTicketEntryBuilder newBuilder() {
        return new RevokeUserEdsAzureUserPermissionTicketEntryBuilder();
    }

    public RevokeUserEdsAzureUserPermissionTicketEntryBuilder withParam(
