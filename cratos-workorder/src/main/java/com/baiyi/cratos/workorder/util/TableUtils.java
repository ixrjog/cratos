...
public class TableUtils {
    ...
    public static String getBusinessPermissionEntryTableRow(WorkOrderTicketEntry entry) {
        TicketEntryProvider<?, ?> provider = TicketEntryProviderFactory.getByBusinessType(entry.getBusinessType());
        UserPermissionBusinessParam.BusinessPermission businessPermission = (UserPermissionBusinessParam.BusinessPermission) provider.loadAs(entry);
