...
public class RevokeUserEdsAwsIamUserPermissionTicketEntryBuilder {

    private WorkOrderTicketParam.AddRevokeUserEdsAccountPermissionTicketEntry param;

    public static RevokeUserEdsAwsIamUserPermissionTicketEntryBuilder  newBuilder() {
        return new RevokeUserEdsAwsIamUserPermissionTicketEntryBuilder ();
    }

    public RevokeUserEdsAwsIamUserPermissionTicketEntryBuilder  withParam(WorkOrderTicketParam.AddRevokeUserEdsAccountPermissionTicketEntry param) {
        this.param = param;
        return this;
    }
