...
public class WorkflowUtils {
    ...
    public static WorkflowModel.Workflow loadAs(WorkOrder workOrder) throws JsonSyntaxException {
    ...
    public static Map<String, WorkflowModel.Node> toNodeMap(WorkOrder workOrder) {
