 ...
 */
@Component
public class GoogleCloudIAMSettingsBuilder extends BaseGoogleCloudSettingsBuilder {

    public GoogleCloudIAMSettingsBuilder(EdsConfigService edsConfigService, CredentialService credentialService) {
