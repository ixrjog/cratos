...
public class BuildWithDetails extends Build {
    ...
    public List<BuildCause> getCauses() {
        ...
        if (!causes.isEmpty()) {
            ...
            for (Map<String, Object> stringObjectMap : causes_blob) {
                BuildCause convertToBuildCause = this.convertToBuildCause(stringObjectMap);
    ...
    public int hashCode() {
        ...
        result = prime * result + Long.hashCode(estimatedDuration);
