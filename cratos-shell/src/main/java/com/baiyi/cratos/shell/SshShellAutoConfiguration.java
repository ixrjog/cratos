...
import com.baiyi.cratos.shell.auth.SshShellPasswordAuthenticationProvider;
...
import static com.baiyi.cratos.shell.SshShellProperties.SSH_SHELL_ENABLE;
...
@ComponentScan(basePackages = {"com.baiyi.cratos.shell"})
@AllArgsConstructor
