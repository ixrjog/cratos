...
import com.baiyi.cratos.eds.kubernetes.client.provider.eks.AmazonEksGenerator;
...
public class  AmazonEksProvider {
     ...
     * @return
     */
    public static KubernetesClient buildClientWithProvider(EdsKubernetesConfigModel.Kubernetes kubernetes) throws URISyntaxException {
