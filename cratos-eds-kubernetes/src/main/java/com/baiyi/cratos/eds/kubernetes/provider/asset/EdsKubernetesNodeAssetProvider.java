...
public class EdsKubernetesNodeAssetProvider extends BaseEdsKubernetesAssetProvider<Node> {
    ...
    public EdsKubernetesNodeAssetProvider(EdsAssetProviderContext context,
