...
public class EdsAliyunAlbAssetProvider extends BaseEdsInstanceAssetProvider<EdsAliyunConfigModel.Aliyun, ListLoadBalancersResponseBody.ListLoadBalancersResponseBodyLoadBalancers> {
    ...
    @Override
    protected List<ListLoadBalancersResponseBody.ListLoadBalancersResponseBodyLoadBalancers> listEntities(ExternalDataSourceInstance<EdsAliyunConfigModel.Aliyun> instance) throws EdsQueryEntitiesException {
    ...
    @Override
    protected EdsAsset toEdsAsset(ExternalDataSourceInstance<EdsAliyunConfigModel.Aliyun> instance, ListLoadBalancersResponseBody.ListLoadBalancersResponseBodyLoadBalancers entity) {
