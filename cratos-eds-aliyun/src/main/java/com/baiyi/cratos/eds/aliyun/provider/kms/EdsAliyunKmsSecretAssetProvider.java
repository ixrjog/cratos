...
public class EdsAliyunKmsSecretAssetProvider extends BaseHasEndpointsEdsAssetProvider<EdsConfigs.Aliyun, AliyunKms.KmsSecret> {
    ...
    public EdsAliyunKmsSecretAssetProvider(EdsAssetProviderContext context, TagService tagService,
    ...
    protected List<EdsAssetIndex> buildIndexes(ExternalDataSourceInstance<EdsConfigs.Aliyun> instance, EdsAsset edsAsset,
        ...
        if (optionalGetSecretValueResponseBody.isPresent()) {
            String contentHash = InfoSummaryUtils.toContentHash(
                    InfoSummaryUtils.SHA256, InfoSummaryUtils.toSHA256(
