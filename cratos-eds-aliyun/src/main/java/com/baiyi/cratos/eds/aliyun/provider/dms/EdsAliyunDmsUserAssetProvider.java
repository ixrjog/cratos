...
public class EdsAliyunDmsUserAssetProvider extends BaseEdsAssetProvider<EdsConfigs.Aliyun, AliyunDms.User> {

    public EdsAliyunDmsUserAssetProvider(EdsAssetProviderContext context) {
        super(context);
    }
