...
public class AliyunClient {
    ...
    public <T extends AcsResponse> T getAcsResponse(String regionId, EdsConfigs.Aliyun aliyun, AcsRequest<T> describe) throws ClientException {
        IAcsClient client = buildAcsClient(regionId, aliyun);
        return client.getAcsResponse(describe);
    }

    public IAcsClient buildAcsClient(String regionId, EdsConfigs.Aliyun aliyun) {
