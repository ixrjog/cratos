...
public class EdsAliyunDomainProvider extends BaseEdsAssetProvider<EdsConfigs.Aliyun, AliyunDomain> {

    public EdsAliyunDomainProvider(EdsAssetProviderContext context) {
        super(context);
    }
