...
public class AwsSubnetAssetToBusinessConverter extends BaseGlobalNetworkAssetToBusinessConverter<AwsEc2.Subnet> {

    public AwsSubnetAssetToBusinessConverter(BusinessAssetBoundService businessAssetBoundService,
