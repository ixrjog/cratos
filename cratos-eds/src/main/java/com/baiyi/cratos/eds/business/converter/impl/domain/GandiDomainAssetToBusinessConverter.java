...
public class GandiDomainAssetToBusinessConverter extends BaseDomainAssetToBusinessConverter<GandiDomain.Domain> {

    public GandiDomainAssetToBusinessConverter(BusinessAssetBoundService businessAssetBoundService) {
