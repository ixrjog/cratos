package com.baiyi.cratos.eds.business.converter.impl.network.base;
...
import com.baiyi.cratos.eds.business.converter.impl.network.model.MainModel;
 ...
 * &#064;Version 1.0
 */
public abstract class BaseGlobalNetworkAssetToBusinessConverter<B> extends BaseAssetToBusinessConverter<GlobalNetworkSubnet, B> {

    private final EdsInstanceService edsInstanceService;
    private final EdsAssetIndexService edsAssetIndexService;

    public BaseGlobalNetworkAssetToBusinessConverter(BusinessAssetBoundService businessAssetBoundService,
