...
public abstract class BaseGlobalNetworkAssetToBusinessWrapper<B> extends BaseAssetToBusinessWrapper<GlobalNetwork, B> {
    ...
    @Override
    protected GlobalNetwork getTarget(EdsAssetVO.Asset asset) {
