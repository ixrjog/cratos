...
public class HwcSubnetAssetToBusinessConverter extends BaseGlobalNetworkAssetToBusinessConverter<HwcSubnet.Subnet> {

    public HwcSubnetAssetToBusinessConverter(BusinessAssetBoundService businessAssetBoundService,
