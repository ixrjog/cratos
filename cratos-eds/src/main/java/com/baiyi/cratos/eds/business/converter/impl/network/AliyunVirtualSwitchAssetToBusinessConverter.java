package com.baiyi.cratos.eds.business.converter.impl.network;
...
import com.baiyi.cratos.eds.business.converter.impl.network.base.BaseGlobalNetworkAssetToBusinessConverter;
...
public class AliyunVirtualSwitchAssetToBusinessConverter extends BaseGlobalNetworkAssetToBusinessConverter<AliyunVirtualSwitch.Switch> {

    public AliyunVirtualSwitchAssetToBusinessConverter(BusinessAssetBoundService businessAssetBoundService,
                                                     EdsInstanceService edsInstanceService,
                                                     EdsAssetIndexService edsAssetIndexService) {
        super(businessAssetBoundService, edsInstanceService, edsAssetIndexService);
    }
