...
public class LdapPersonAssetToBusinessConverter extends BaseAssetToBusinessConverter<User, LdapPerson.Person> {

    public LdapPersonAssetToBusinessConverter(BusinessAssetBoundService businessAssetBoundService) {
