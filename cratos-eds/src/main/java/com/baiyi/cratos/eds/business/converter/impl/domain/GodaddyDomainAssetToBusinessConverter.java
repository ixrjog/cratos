...
public class GodaddyDomainAssetToBusinessConverter extends BaseDomainAssetToBusinessConverter<GodaddyDomain.Domain> {

    public GodaddyDomainAssetToBusinessConverter(BusinessAssetBoundService businessAssetBoundService) {
