 ...
 * @Version 1.0
 */
public interface AssetToBusinessConverter<B extends ToBusinessTarget> extends BaseBusiness.IBusinessTypeAnnotate, EdsAssetTypeOfAnnotate, InitializingBean {
    ...
    default void afterPropertiesSet() {
        AssetToBusinessConverterFactory.register(this);
    }
