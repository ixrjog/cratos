package com.baiyi.cratos.eds.business.converter.impl.domain.base;
 ...
 * @Version 1.0
 */
public abstract class BaseDomainAssetToBusinessConverter<B> extends BaseAssetToBusinessConverter<Domain, B> {

    public BaseDomainAssetToBusinessConverter(BusinessAssetBoundService businessAssetBoundService) {
