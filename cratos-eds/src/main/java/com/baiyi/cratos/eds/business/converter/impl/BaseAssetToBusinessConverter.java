package com.baiyi.cratos.eds.business.converter.impl;
...
public abstract class BaseAssetToBusinessConverter<B extends ToBusinessTarget, T> implements AssetToBusinessConverter<B> {
