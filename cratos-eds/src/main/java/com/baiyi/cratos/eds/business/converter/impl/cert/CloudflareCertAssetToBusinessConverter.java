...
public class CloudflareCertAssetToBusinessConverter extends BaseAssetToBusinessConverter<Certificate, CloudFlareCert.Certificate> {

    public CloudflareCertAssetToBusinessConverter(BusinessAssetBoundService businessAssetBoundService) {
