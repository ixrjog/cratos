...
public class HwcElbCertAssetToBusinessConverter extends BaseAssetToBusinessConverter<Certificate, HwcElb.Cert> {

    public HwcElbCertAssetToBusinessConverter(BusinessAssetBoundService businessAssetBoundService) {
