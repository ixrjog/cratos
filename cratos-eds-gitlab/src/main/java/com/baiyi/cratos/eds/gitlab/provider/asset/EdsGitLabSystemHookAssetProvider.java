...
public class EdsGitLabSystemHookAssetProvider extends BaseEdsAssetProvider<EdsConfigs.GitLab, GitLabEventParam.SystemHook> {

    public EdsGitLabSystemHookAssetProvider(EdsAssetProviderContext context) {
        super(context);
    }
