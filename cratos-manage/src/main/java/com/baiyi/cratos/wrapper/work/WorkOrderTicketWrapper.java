...
public class WorkOrderTicketWrapper extends BaseDataTableConverter<WorkOrderTicketVO.Ticket, WorkOrderTicket> implements BaseBusinessDecorator<WorkOrderTicketVO.HasTicket, WorkOrderTicketVO.Ticket> {
