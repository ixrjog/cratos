...
public class WorkOrderTicketEntryWrapper<T> extends BaseDataTableConverter<WorkOrderTicketVO.TicketEntry<T>, WorkOrderTicketEntry> implements BaseBusinessDecorator<WorkOrderTicketVO.HasTicketEntries, WorkOrderTicketVO.TicketEntry<T>> {
