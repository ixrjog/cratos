...
public class WorkOrderTicketNodeWrapper extends BaseDataTableConverter<WorkOrderTicketVO.TicketNode, WorkOrderTicketNode> implements BaseBusinessDecorator<WorkOrderTicketVO.HasTicketNodes, WorkOrderTicketVO.TicketNode> {
