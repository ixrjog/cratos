...
public class SshInstanceWrapper extends BaseDataTableConverter<SshInstanceVO.Instance, SshSessionInstance> implements BaseBusinessDecorator<SshInstanceVO.HasSessionInstances, SshInstanceVO.Instance> {
