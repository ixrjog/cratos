...
public class TrafficLayerRecordWrapper extends BaseDataTableConverter<TrafficLayerDomainRecordVO.Record, TrafficLayerDomainRecord> implements IBaseWrapper<TrafficLayerDomainRecordVO.Record> {
