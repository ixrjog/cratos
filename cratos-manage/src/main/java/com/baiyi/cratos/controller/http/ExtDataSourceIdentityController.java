...
public class ExtDataSourceIdentityController {
    ...
    public HttpResult<EdsIdentityVO.CloudIdentityDetails> queryCloudIdentityDetails(
        ...
        return HttpResult.of(cloudIdentityExtension.queryCloudIdentityDetails(queryCloudIdentityDetails));
    }
    ...
    public HttpResult<EdsIdentityVO.CloudAccount> createCloudAccount(
        ...
        return HttpResult.of(cloudIdentityExtension.createCloudAccount(createCloudAccount));
    }
    ...
    public HttpResult<EdsIdentityVO.LdapIdentityDetails> queryLdapIdentityDetails(
        ...
        return HttpResult.of(ldapIdentityExtension.queryLdapIdentityDetails(queryLdapIdentityDetails));
    }
    ...
    public HttpResult<EdsIdentityVO.LdapIdentity> createLdapIdentity(
        ...
        return HttpResult.of(ldapIdentityExtension.createLdapIdentity(createLdapIdentity));
    }
    ...
    public HttpResult<EdsIdentityVO.LdapIdentity> resetLdapUserPassword(
        ...
        return HttpResult.of(ldapIdentityExtension.resetLdapUserPassword(resetLdapUserPassword));
    }
    ...
    public HttpResult<Set<String>> queryLdapGroups(
        ...
        return HttpResult.of(ldapIdentityExtension.queryLdapGroups(queryLdapGroups));
    }
    ...
    public HttpResult<EdsIdentityVO.DingtalkIdentityDetails> queryDingtalkIdentityDetails(
        ...
        return HttpResult.of(dingtalkIdentityExtension.queryDingtalkIdentityDetails(queryDingtalkIdentityDetails));
    }
    ...
    public HttpResult<EdsIdentityVO.GitLabIdentityDetails> queryGitLabIdentityDetails(
        ...
        return HttpResult.of(gitLabIdentityExtension.queryGitLabIdentityDetails(queryGitLabIdentityDetails));
    }
    ...
    public HttpResult<EdsIdentityVO.MailIdentityDetails> queryMailIdentityDetails(
        ...
        return HttpResult.of(mailIdentityExtension.queryMailIdentityDetails(queryMailIdentityDetails));
    }
