...
public class EdsEagleCloudSaseHookAssetProvider extends BaseEdsAssetProvider<EdsConfigs.Sase, EagleCloudEventParam.SaseHook> {

    public EdsEagleCloudSaseHookAssetProvider(EdsAssetProviderContext context) {
        super(context);
    }
